...
tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/DeepSeek-R1-Distill-Qwen-1.5B")
llm = LLM(model="/root/autodl-tmp/DeepSeek-R1-Distill-Qwen-1.5B", gpu_memory_utilization=0.15)

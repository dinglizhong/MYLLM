...
parser.add_argument('--no_tool_call_base_url', type=str, default="https://dashscope.aliyuncs.com/compatible-mode/v1")
# 大模型，能力更强，但是不具备工具调用能力，生成工具调用策略
parser.add_argument('--no_tool_call_model_name', type=str, default="qwen2.5-coder-32b-instruct")
parser.add_argument('--no_tool_call_api_key', type=str, default="sk-0947643a8c1c45908ee5075606dec466")
parser.add_argument('--tool_call_base_url', type=str, default="https://dashscope.aliyuncs.com/compatible-mode/v1")
# 小模型，能力更弱，具备工具调用能力，按照大模型生成的工具调用策略，去调用工具
parser.add_argument('--tool_call_model_name', type=str, default="qwen2.5-7b-instruct")
parser.add_argument('--tool_call_api_key', type=str, default="sk-0947643a8c1c45908ee5075606dec466")

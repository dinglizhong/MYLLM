...
if __name__ == '__main__':
    ...
    teacher_tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/glm-4-9b-chat",trust_remote_code=True)
    teacher_model = AutoModelForCausalLM.from_pretrained("/root/autodl-tmp/glm-4-9b-chat",trust_remote_code=True)
    teacher_model.eval()
    teacher_model.cuda()
    ...
    train_dataset = SFTDataset('./datasets/example.json', tokenizer=tokenizer)

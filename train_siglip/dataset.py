...
if __name__ == '__main__':
    ...
    tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/train_siglip_from_scratch/chinese-roberta-wwm-ext')
    processor = AutoProcessor.from_pretrained('/root/autodl-tmp/train_siglip_from_scratch/vit-base-patch16-224')
    
    dataset = SiglipDataset(text_data_path='/root/autodl-tmp/train_siglip_from_scratch/MUGE/all_texts.jsonl',
                            image_data_path='/root/autodl-tmp/train_siglip_from_scratch/MUGE/all_imgs.tsv',
                            tokenizer=tokenizer,
                            processor=processor,
                            max_seq_length=64)

...
api_key = 'sk-PcWf3MkCv4HODh18bE00d1xndEI3KVmwwTZYuo0bvoIgjdhj'
...
# 创建控制台处理器（输出到 stderr，避免干扰 MCP 的 stdout 通信）
...
def search(query: str) -> str:
    ...
    if image_results:
        image_context = "\n\n## 相关图片\n\n"
        for img_url, desc in image_results.items():
            image_context += f"![{desc}]({img_url})\n\n"
        aggregated_contexts.append(image_context)

...
inputs = {"user_message": "对所给文档进行分析，文档路径为/root/autodl-tmp/langgraph_agent/student_habits_performance.csv，生成分析报告，生成的所有产物保存到路径/root/autodl-tmp/langgraph_agent/WorkSpace/", 
          "plan": None,
          "observations": [], 
          "final_report": ""}

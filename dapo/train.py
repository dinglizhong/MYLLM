...
"""
    ...
    # 策略模型
    tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/Qwen2.5-3B-Instruct')
    model = AutoModelForCausalLM.from_pretrained('/root/autodl-tmp/Qwen2.5-3B-Instruct')
    # 奖励函数
